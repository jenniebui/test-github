...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(data, names='class', title='Total Success Launch for site {}'.format(entered_site))
        return fig
# TASK 4:
...
def get_scatter_chart(entered_site, payload):
    ...
    if entered_site == 'ALL':
        ...
        # return the outcomes piechart for a selected site
        data = filtered_df[filtered_df['Launch Site'] == entered_site]
        fig = px.scatter(data, y='class', x ='Payload Mass (kg)', color='Booster Version Category',
        title='Correlation between Payload and Success for Sites {}'.format(entered_site))
        return fig
